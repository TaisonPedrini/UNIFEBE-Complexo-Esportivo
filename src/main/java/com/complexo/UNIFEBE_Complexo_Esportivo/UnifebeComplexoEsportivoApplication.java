package com.complexo.UNIFEBE_Complexo_Esportivo;

import com.complexo.UNIFEBE_Complexo_Esportivo.controller.ValidarLogin;
import com.complexo.UNIFEBE_Complexo_Esportivo.dao.*;
import com.complexo.UNIFEBE_Complexo_Esportivo.view.ElementosComuns;
import com.complexo.UNIFEBE_Complexo_Esportivo.view.TelaAdmin;
import com.complexo.UNIFEBE_Complexo_Esportivo.view.TelaUsuario;
...
public class UnifebeComplexoEsportivoApplication {

	// Todos os códigos daqui em diante são do projeto antigo
                ...
                switch (usuario.getTipo()) {
                    ...
                    case 'C':
                        ...
                        do {
                            ...
                            switch (this.opcao) {
                                case 1:
                                    new UnifebeComplexoEsportivoApplication().consultaAmbientes(usuario);
                                    break;

                                case 2:
                                    new UnifebeComplexoEsportivoApplication().agendamentoDeAmbientes(usuario);
                                    break;
	...
	public static void main(String[] args) {
		//SpringApplication.run(UnifebeComplexoEsportivoApplication.class, args);

		// Chamada antiga
		new UnifebeComplexoEsportivoApplication().run();
	}
